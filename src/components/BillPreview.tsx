...
export function BillPreview({ invoiceNumber, items, totalAmount, isVisible }: BillPreviewProps) {
  ...
  return (
    <div className={`fixed top-0 left-0 h-full w-1/2 bg-[#f5f3ed] z-[55] transform transition-transform duration-300 ease-out overflow-y-auto print:static print:w-full ${
